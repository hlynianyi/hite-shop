          ...
          <div className='bg-white mt-6  text-opensans text-lg w-full'>
            <div className='flex justify-between'>
              <div className='flex flex-col space-y-2 w-full'>
                <input onChange={handleFilterChange} value={minPrice} name='min' type='number' placeholder='От' className='h-8 rounded border border-blue-200 text-productprice text-2xs px-2' />
                <input onChange={handleFilterChange} value={maxPrice} name='max' type='number' placeholder='До' className='h-8 rounded border border-blue-200 text-productprice text-2xs px-2' />
                <button onClick={resetPriceFilter} className='h-8 bg-customblue text-white text-lg px-2 py-1 rounded font-poiret'>RESET</button>
                <button onClick={applyFilter} className='h-8 bg-customblue text-white text-lg px-2 py-1 rounded font-poiret'>OK</button>
              </div>
            </div>
          </div>
        )}
        ...
        {isCategoryFilterOpen && (
          <div className='flex flex-col items-start bg-white mt-4 ml-4 w-80 text-opensans text-lg'>
            <button 
              ...
              className='pb-1 text-customblue text-2xs font-light text-opensans'
            >
              ALL
            </button>
            {
